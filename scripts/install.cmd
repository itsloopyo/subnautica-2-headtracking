...
:: --- CONFIG BLOCK ---
set "GAME_ID=subnautica-2"
set "MOD_DISPLAY_NAME=Subnautica 2 Head Tracking"
set "MOD_DLLS=Subnautica2HeadTracking.asi HeadTracking.ini"
set "MOD_INTERNAL_NAME=Subnautica2HeadTracking"
set "MOD_VERSION=0.0.0"
set "STATE_FILE=.headtracking-state.json"
set "FRAMEWORK_TYPE=ASILoader"
set "ASI_LOADER_NAME=winmm.dll"
set "MOD_CONTROLS=Controls: Home / Ctrl+Shift+T = recenter, End / Ctrl+Shift+Y = toggle tracking, Page Down / Ctrl+Shift+H = toggle yaw mode"
